 ...
 * @Created at 2017/11/26 0026  17:23
 * @des
 */

public class Constant {

    public static final String[] SUPPORT_APP_PK_LIST = {
    ...
    public static final String SP_KEY_ALI_EXPECT_STEP = "sp_key_ali_expect_step";
    ...
    public static final String SP_KEY_DELETE_ALI_SPORT_RECORD = "sp_key_delete_ali_sport_record";
