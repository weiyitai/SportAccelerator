package com.qianbajin.sportaccelerator.v4;
 ...
 * @Created at 2017/12/1 0001  23:45
 * @des
 */
...
public class PreferenceManagerCompat {
     ...
     *         root).
     */
    static PreferenceScreen inflateFromIntent(PreferenceManager manager, Intent queryIntent, PreferenceScreen rootPreferences) {
        try {
            Method m = PreferenceManager.class.getDeclaredMethod("inflateFromIntent", Intent.class, PreferenceScreen.class);
            m.setAccessible(true);
            PreferenceScreen prefScreen = (PreferenceScreen) m.invoke(manager, queryIntent, rootPreferences);
            return prefScreen;
        } catch (Exception e) {
     ...
     * @hide
     */
    static PreferenceScreen inflateFromResource(PreferenceManager manager, Activity context, int resId, PreferenceScreen rootPreferences) {
        try {
            Method m = PreferenceManager.class.getDeclaredMethod("inflateFromResource", Context.class, int.class, PreferenceScreen.class);
            m.setAccessible(true);
            PreferenceScreen prefScreen = (PreferenceScreen) m.invoke(manager, context, resId, rootPreferences);
            return prefScreen;
        } catch (Exception e) {
